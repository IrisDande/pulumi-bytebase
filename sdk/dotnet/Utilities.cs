...
namespace bytebaseDatabase.bytebase
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("bytebaseDatabase.bytebase.version.txt");
    ...
    internal sealed class bytebaseResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public bytebaseResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
